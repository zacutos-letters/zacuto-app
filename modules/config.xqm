...
(:
 ...
 :)
declare variable $config:default-template :="zacuto-letter.html";
...
case "A4732" return "Amsterdam, Etz Ḥayyim Library, MS 47 A 32"

case "BJTS" return "Budapest, JTSL, MS (no shelfmark)"

case "B151" return "Budapest, MS Kaufmann A 151"

case "B459" return "Budapest, MS Kaufmann A 459"

case "B557" return "Budapest,  MS Kaufmann A 557"

case "J1999" return "Iggerot ha-ReMeZ, Jerusalem 1999"

case "J165" return "Jerusalem, Benayahu Library, MS K 165"

case "JRMZ" return "Jerusalem, Benayahu Library, (no shelfmark)"

case "J933" return "Jerusalem, NLI, MS Heb. 8° 933"

case "J1466" return "Jerusalem, NLI, MS Heb. 8° 1466"

case "J2011" return "Jerusalem, NLI, MS Heb. 8° 2011"

case "J5633" return "Jerusalem, NLI, MS Heb. 28° 5633"

case "L9165" return "London, BL, MS Or. 9165"

case "L112" return "London, Montefiore, MS 112"

case "L482" return "London, Montefiore, MS 482"

case "L1780" return "Iggerot ha-ReMeZ, Livorno 1780"

case "MAE" return "Mantua, Archivio Ebraico Mantova"

case "M149" return "Mantua, Biblioteca Teresiana, MS ebr. 149"

case "MO87" return "Moscow, RSL, MS Schneerson 87"

case "MO579" return "Moscow, RSL, MS Guenzburg 579"

case "N3761" return "New York, JTSL, MS 3761"

case "N3820" return "New York, JTSL, MS 3820"

case "N3836" return "New York, JTSL, MS 3836"

case "PM" return "Pardes Moshe (unknown owner)"

case "U2019" return "Unknown Library, Sold in 2019"

case "U2021" return "Unknown Library, Sold in 2021"

case "V1761" return "Print, Shut ha-ReMeZ, Venice 1761"

case "W66" return "Warsaw, Ringelblum Institute, MS 66"

case "WS129" return "Washington, LOC, MS 129"
                default return $label
        }
    }
    
    (:map {
        "dimension": "persMentioned",
        "heading": "Person Mentioned",
        "max": (),
        "hierarchical": false(),
        "output": function($label) {
            switch($label)
                case "ZP00001" return "Moses Zacuto"
                case "ZP00002" return "Benjamin ha-Kohen"
                case "ZP00003" return "Abraham Rovigo"
                case "Samiga" return "Samiga"
                case "Shalit" return "Shalit"
                case "Ari" return "Ari"
                default return $label
        }
    }:)
...
declare variable $config:data-exclude := (
    ...
    collection($config:data-root || "/letters/aux")/tei:TEI
);

(:~
 : The main ODD to be used by default
 :)
declare variable $config:default-odd :="zacuto-letters.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("zacuto-letters.odd");
