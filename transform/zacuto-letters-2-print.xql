...
module namespace model="http://www.tei-c.org/pm/models/zacuto-letters-2/fo";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(app) return
                        fo:inline($config, ., ("tei-app", css:map-rend-to-class(.)), .)
                    ...
                    case element(rdg) return
                        fo:inline($config, ., ("tei-rdg", css:map-rend-to-class(.)), .)
                    case element() return
