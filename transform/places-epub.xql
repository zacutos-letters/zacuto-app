...
module namespace model="http://www.tei-c.org/pm/models/places/epub";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(body) return
                        (
                            epub:block($config, ., ("tei-body1", css:map-rend-to-class(.)), .),
                    ...
                    case element(persName) return
                        if (ancestor::p) then
                            epub:alternate($config, ., ("tei-persName1", "persName", css:map-rend-to-class(.)), ., ., id(@key, doc("/db/apps/tei-publisher/data/playground/aux/Zacuto_People.xml")))
                        else
