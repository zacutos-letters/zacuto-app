...
module namespace model="http://www.tei-c.org/pm/models/zacuto-letters-2/latex";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(app) return
                        latex:inline($config, ., ("tei-app", css:map-rend-to-class(.)), .)
                    ...
                    case element(rdg) return
                        latex:inline($config, ., ("tei-rdg", css:map-rend-to-class(.)), .)
                    case element() return
