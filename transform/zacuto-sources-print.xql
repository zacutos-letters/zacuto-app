...
module namespace model="http://www.tei-c.org/pm/models/zacuto-sources/fo";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(teiHeader) return
                        fo:metadata($config, ., ("tei-teiHeader", css:map-rend-to-class(.)), .)
                    ...
                    case element(fileDesc) return
                        fo:title($config, ., ("tei-fileDesc", css:map-rend-to-class(.)), titleStmt)
                        ...
                        if (parent::titleStmt/parent::fileDesc) then
                            (
                                if (preceding-sibling::title) then
                                    fo:text($config, ., ("tei-title1", css:map-rend-to-class(.)), ' — ')
                                else
                                    (),
