(:~
    ...
    ODD: /db/apps/zacutos-letters/resources/odd/zacuto-letters-2.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/pm/models/zacuto-letters-2/web";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(note) return
                        if (@type='summary') then
                            ...
                            if (parent::person) then
                                ...
                                html:note($config, ., ("tei-note3", css:map-rend-to-class(.)), ., @place, @n)
                    ...
                    case element(app) return
                        html:inline($config, ., ("tei-app", css:map-rend-to-class(.)), .)
                    ...
                    case element(idno) return
                        if (parent::person) then
                            html:omit($config, ., ("tei-idno", css:map-rend-to-class(.)), .)
                        else
                            $config?apply($config, ./node())
                    ...
                    case element(placeName) return
                        html:inline($config, ., ("tei-placeName", "placeName", css:map-rend-to-class(.)), .)
                    ...
                    case element(rdg) return
                        html:inline($config, ., ("tei-rdg", css:map-rend-to-class(.)), .)
