(:~
    ...
    ODD: /db/apps/zacutos-letters/resources/odd/L1780.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/pm/models/L1780/web";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(app) return
                        html:omit($config, ., ("tei-app", css:map-rend-to-class(.)), .)
                    case element(lem) return
                        if (not(@wit="L1780")) then
